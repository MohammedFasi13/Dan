...
// ------------------------------------------------------------------
// 🎯 FIX: Correct Font Awesome imports
// ------------------------------------------------------------------
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faLinkedin } from '@fortawesome/free-brands-svg-icons';

// ✅ No image imports — public assets do not need imports

// ✅ Team data with correct public asset paths (EXACT names from screenshot)
const teamData = [
  {
    name: "Dania Sujath",
  ...
  },
  {
    ...
    bio: (
      <>
        ...
        <br /><br />
        After years of working with global leaders like Aramco, NEOM, Ma’aden, and ADNOC, I founded DAN International with a clear mission: to transform HR services and fix what’s broken in global workforce management. At DAN, we don’t just fill positions — we provide comprehensive, end-to-end HR solutions that build careers, empower businesses, and drive lasting success. From our 72-hour candidate response policy to military-grade visa handling and a 95% offer acceptance rate, every step of our process is designed with precision, transparency, and integrity. DAN International is more than an HR service provider — it’s a commitment to elevate people, performance, and the future of workforce excellence.
      </>
    ),
    img: "/assets/Mubassir-Mohammed.jpeg",
  ...
  },
  {
    ...
    bio: "With a strong focus on strategic growth and client engagement, Mohammed Salman Ali brings valuable experience in business development across the GCC region. He is dedicated to identifying new market opportunities, fostering long-term partnerships, and driving sustainable business expansion.",
    img: "https://www.freeiconspng.com/thumbs/male-icon/male-icon-32.png",
    linkedin: "https://www.linkedin.com/in/mohammed-salman-ali-b344a9306/"
  },
  {
    name: "Mir Azam Ali",
    role: "HR Business Partner",
    bio: "Mir Azam Ali serves as a key link between leadership and employees, aligning human resource strategies with overall business objectives. As an HR Business Partner, he focuses on talent management, employee engagement, and organizational development.",
    img: "https://www.freeiconspng.com/thumbs/male-icon/male-icon-32.png",
  ...
  },
  {
    ...
    bio: "Mohammed Shadab Chowdhary plays a vital role in bridging business growth and talent acquisition. As a Business and Recruitment Specialist, he focuses on identifying new opportunities, supporting client needs, and sourcing the right talent to meet organizational goals.",
    img: "https://www.freeiconspng.com/thumbs/male-icon/male-icon-32.png",
    linkedin: "https://www.linkedin.com/in/mohammed-shadab-chowdhary-shrm-539295a4/"
  },
  {
    name: "Mohammed Adnan",
    role: "Accounts & Recruitment Executive",
    bio: "Mohammed Adnan plays a dual role at our organization, efficiently managing both financial operations and talent acquisition. With expertise in handling billing, purchase and sales orders, contract management, and RFQs, he ensures smooth and accurate accounting processes.",
    img: "/assets/Mohammed-Adnan.jpeg",
